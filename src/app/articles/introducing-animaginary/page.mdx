...
export const article = {
  author: 'Adam Wathan',
  date: '2022-09-02',
  title: 'Component based UI patterns with django-cotton and alpine JS',
  description:
    'Bring your basic Django templates to life with Alpine JS and Django Cotton with react-like components systems',
}
